...
')
     ...
     */ 
         ...
         *
         * @param string $url
         * @return \App\Services\Dashboard\Dashboard 
         * @static 
         */ 
        public static function script($url)
        {
                        /** @var \App\Services\Dashboard\Dashboard $instance */
         ...
         * @static 
         */ 
        public static function inlineStylesheets($stylesheet)
        {
                        /** @var \App\Services\Dashboard\Dashboard $instance */
                        return $instance->inlineStylesheets($stylesheet);
        }
                    /**
         * 
         *
     ...
     */ 
         ...
         * @static 
         */ 
        public static function setRootView($name)
        {
                        /** @var \Inertia\ResponseFactory $instance */
                        return $instance->setRootView($name);
        }
                    /**
         * 
         *
         ...
         * @static 
         */ 
        public static function getShared($key = null, $default = null)
        {
                        /** @var \Inertia\ResponseFactory $instance */
                        return $instance->getShared($key, $default);
        }
                    /**
         * 
         *
        ...
        public static function macro($name, $macro)
        {
                        \Inertia\ResponseFactory::macro($name, $macro);
        }
                    /**
         * Mix another object into the class.
         *
        ...
        public static function mixin($mixin, $replace = true)
        {
                        \Inertia\ResponseFactory::mixin($mixin, $replace);
        }
                    /**
         * Checks if macro is registered.
         *
        ...
        public static function hasMacro($name)
        {
                        return \Inertia\ResponseFactory::hasMacro($name);
        }
...
namespace  { 
            ...
            class Dashboard extends \App\Services\Dashboard\Facade\Dashboard {}
